  ...
  const packages = [
    {
      ...
      price: "₹15 – 50 Lakhs",
      img: "https://images.pexels.com/photos/230290/pexels-photo-230290.jpeg",
    },
    {
    ...
    },
    {
      ...
      price: "₹10 – 35 Lakhs",
      img: "https://images.pexels.com/photos/169181/pexels-photo-169181.jpeg",
    },
    {
      ...
      price: "₹30 – 80 Lakhs",
      img: "https://images.pexels.com/photos/1691984/pexels-photo-1691984.jpeg",
    },
  ];

  return (
    <section className="py-20 bg-linear-to-br from-amber-50 to-yellow-100" id="cost-packages">
