...
export default function DestinationWedding2() {
  return (
    <section className="w-full bg-linear-to-b from-amber-50 via-pink-50 to-rose-50 py-20 px-6 lg:px-20">
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-20 items-center">
        ...
        >
          ...
          <Link to='/book-event'>
          <Button className="mt-6 bg-rose-600 hover:bg-rose-700 text-white rounded-full px-6 py-3 text-lg shadow-lg">
      ...
      >
        ...
        <Link to='/book-event'>
        <Button className="bg-rose-600 hover:bg-rose-700 text-white rounded-full px-8 py-3 text-lg shadow-md">
          Start Planning Now
        </Button>
        </Link>
      </motion.div>
