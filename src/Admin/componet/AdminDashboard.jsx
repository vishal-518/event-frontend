      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-800 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="bg-blue-600 hover:bg-blue-700 p-4 rounded-lg transition">
              Upload New Event Images
            </button>
            <button className="bg-green-600 hover:bg-green-700 p-4 rounded-lg transition">
              View All Bookings
            </button>
            <button className="bg-purple-600 hover:bg-purple-700 p-4 rounded-lg transition">
              Manage Users
            </button>
          </div>
        </div>
